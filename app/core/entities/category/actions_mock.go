...
func (mock *ActionsMock) Create(contextMoqParam context.Context, category Category) (Category, error) {
...
// Get calls GetFunc.
func (mock *ActionsMock) Get(contextMoqParam context.Context, external id.External) (Category, error) {
	if mock.GetFunc == nil {
...
// List calls ListFunc.
func (mock *ActionsMock) List(contextMoqParam context.Context, filter Filter) ([]Category, error) {
...
func (mock *ActionsMock) Update(contextMoqParam context.Context, category Category) error {
